...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler('/tmp/feishu_auth_debug.log'),
...
# 授权URL
AUTH_URL = f"https://open.feishu.cn/open-apis/authen/v1/authorize?app_id={APP_ID}&redirect_uri={REDIRECT_URI}&scope=bitable:app&state=feishu_auth"
...
<head>
    ...
    <style>
        ...
        .url {{ font-size: 12px; color: #666; word-break: break-all; margin: 20px 0; }}
    </style>
</head>
<body>
    <div class="container">
        ...
        if parsed.path.startswith('/callback'):
            ...
            if 'code' in params:
                ...
                try:
                    ...
                    logger.info(f"请求参数: app_id={APP_ID}, grant_type=authorization_code")
...
def main():
    ...
    logger.info("调试日志: /tmp/feishu_auth_debug.log")
