...
# 导入飞书路径模块
# 优先使用 Desktop/DMS 路径
_feishu_scripts = Path.home() / 'Desktop' / 'DMS' / 'skills' / 'feishu-universal' / 'scripts'
if not _feishu_scripts.exists():
    # 回退到 .claude/skills 路径
    _feishu_scripts = Path.home() / '.claude' / 'skills' / 'feishu-universal' / 'scripts'
if not _feishu_scripts.exists():
    # 回退到相对路径
